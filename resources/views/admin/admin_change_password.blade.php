                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form method="POST" action="{{route('admin.update.password.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    @if (session('status'))
                              ...
                              <div class="alert alert-danger" role="alert">
                                    ...
                                    @endif
                                    <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i>Admin Password Info</h5>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
